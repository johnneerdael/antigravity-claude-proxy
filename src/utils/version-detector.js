...
function getProductJsonPaths() {
    ...
    if (os === 'darwin') {
        ...
        paths.push(join(process.env.HOME || '', 'Applications', 'Antigravity.app', 'Contents', 'Resources', 'app', 'product.json'));
    } else if (os === 'win32') {
        ...
        paths.push('/opt/Antigravity/resources/app/product.json');
        paths.push(join(process.env.HOME || '', '.local', 'share', 'antigravity', 'resources', 'app', 'product.json'));
...
/**
 * Log version detection results once at startup.
 */
